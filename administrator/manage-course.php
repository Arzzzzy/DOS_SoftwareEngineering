    ...
    <section class="main">
                    ...
                    <div class="card card-1" id="addFaculty">
                        ...
                        <div class="card--data">
                            <div class="card--content">
                                <h1><?php total_rows("tblfaculty") ?> Colleges </h1>
                                <button class="add"><i class="ri-add-line"></i>Add College</button>
                            </div>
                       ...
                       GROUP BY f.Id";
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    echo "<td>
                                    <a href='edit-faculty.php?id={$row["Id"]}' class='edit-btn'><i class='ri-pencil-line'></i></a>
                                    <span><i class='ri-delete-bin-line delete' data-id='{$row["Id"]}' data-name='faculty'></i></span></td>";
                                    echo "</tr>";
                                }
                            } else {
                        ...
                        GROUP BY c.Id";
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    echo "<td>" . $row["date_created"] . "</td>";
                                    echo "<td>
                                    <a href='edit-course.php?id={$row["Id"]}' class='edit-btn'><i class='ri-pencil-line'></i></a>
                                    <span><i class='ri-delete-bin-line delete' data-id='{$row["Id"]}' data-name='course'></i></span></td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='6'>No records found</td></tr>";
                        ...
                        <tbody>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    echo "<td>" . $row["date_created"] . "</td>";
                                    echo "<td>
                                    <a href='edit-unit.php?id={$row["Id"]}' class='edit-btn'><i class='ri-pencil-line'></i></a>
                                    <span><i class='ri-delete-bin-line delete' data-id='{$row["Id"]}' data-name='unit'></i></span></td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='6'>No records found</td></tr>";
        ...
        <div class="formDiv" id="addFacultyForm" style="display:none; ">
            <form method="POST" action="" name="addFaculty" enctype="multipart/form-data">
                ...
                <input type="text" name="facultyName" placeholder="College Name" required>
                <input type="text" name="facultyCode" placeholder="College Code" required>
                <input type="submit" class="submit" value="Save College" name="addFaculty">
            </form>
        </div>
