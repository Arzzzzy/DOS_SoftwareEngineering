                        ...
                        <tbody>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    echo "<td><a href='edit-faculty.php?id={$row["Id"]}' class='edit-btn'><i class='ri-pencil-line'></i></a>
                                    <span><span><i class='ri-delete-bin-line delete' data-id='{$row["Id"]}' data-name='students'></i></span></td>";
                                    echo "</tr>";
                                }
                            } else {
