                            ...
                            <tr>
                                ...
                                if ($result) {
                                    foreach ($result as $row) {
                                        ...
                                        echo "<td><a href='edit-lecture.php?id={$row["Id"]}' class='edit-btn'><i class='ri-pencil-line'></i></a>
                                        <span><span><i class='ri-delete-bin-line delete' data-id='{$row["Id"]}' data-name='lecture'></i></span></td>";
                                        echo "</tr>";
                                    }
                                } else {
