...
<head>
    ...
    <title>MMSU Attendify</title>
    <link rel="icon" href="resources/images/logo/mmsulogo.png" type="image/png">
...
<body>
    <div class="container" id="signIn">
        ...
        <div class="logo-container">
            <img src="resources/images/logo/mmsu-logo.png" alt="MMSU Logo" class="logo">
        </div>
        <h1 class="form-title">Welcome to <span>MMSU</span> Attendify</h1>
        <p class="description">
            Say goodbye to manual roll calls with advanced facial recognition technology for effortless attendance tracking.
        </p>
        <?php
        ...
        <p class="footer">
        Fulfilling the requirements for the CMPSC 146	Software Engineering
        </p>
        <p class="credits">
        © 2025 D.O.S All Rights Reserved.
        </p>
    </div>
