...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <div class="time-container">
                <h2 id="currentTime" style="text-align:center; font-size: 24px; font-weight:bold; color: green;"></h2></div>  
            ...
            <div class="attendance-button">
                ...
                <button id="endAttendance" class="add">Save and End Attendance</button>
            </div>
            <br>
    ...
    updateTime(); // Initialize time immediately on page load
</script>
